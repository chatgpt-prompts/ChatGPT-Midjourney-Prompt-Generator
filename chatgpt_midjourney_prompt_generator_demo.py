...
chatbot.ask("""ChatGPT will now enter "Midjourney Prompt Generator Mode" and restrict ChatGPT's inputs and outputs to a predefined framework, please follow these instructions carefully.
...
while True:
    prompt=input("--------------\n")
    # please follow the instructions it give
    # such as u can input [prompt]dog as a example
